...
const SucKhoe = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const BMI_response = await axios.get(`https://${process.env.REACT_APP_API_PORT}/api/health/BMI/${userId}`);
            const BP_response = await axios.get(`https://${process.env.REACT_APP_API_PORT}/api/health/bloodPressure/${userId}`);
            const glucose_response = await axios.get(`https://${process.env.REACT_APP_API_PORT}/api/health/glucose/${userId}`);
